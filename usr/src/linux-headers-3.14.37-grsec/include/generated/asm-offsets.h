...
#define TI_sysenter_return 80 /* offsetof(struct thread_info, sysenter_return)	# */
...
#define TSS_size 8896 /* sizeof(struct tss_struct)	# */
...
#define TI_lowest_stack 88 /* offsetof(struct thread_info, lowest_stack)	# */
#define TI_task_thread_sp0 -2112 /* offsetof(struct task_struct, thread.sp0) - offsetof(struct task_struct, tinfo)	# */
...
#define THREAD_SIZE_asm 16384 /* THREAD_SIZE	# */
